    ...
    */
        ...
        */
         ...
         */
            ...
            //Step 3. Enter any valid first name.
            driver.findElement(By.cssSelector("[name='firstname']")).sendKeys("Marco");

            //Step 4. Enter any valid last name.
            driver.findElement(By.cssSelector("[name='lastname']")).sendKeys("Franco");

            // Step 5. Enter any valid user name.
            driver.findElement(By.cssSelector("[name='username']")).sendKeys("marcfranc");

            //Step 6. Enter any valid email adress.
            driver.findElement(By.cssSelector("[name='email']")).sendKeys("franco@gmail.com");
